#!/usr/bin/env python3
"""Build THESIS.pdf from THESIS.md with WeasyPrint. Research deposit helper; not a care tool."""
...
<head>
<meta charset="utf-8"/>
<title>Thesis #10. Immunometabolic tumour-immune ODEs under explicit non-parameters</title>
<style>
@page {{
  size: A4;
  margin: 22mm 20mm 24mm 20mm;
  @bottom-center {{
    content: "Ogbonna KE. Thesis #10. Computational research only. Not a medical device. Not a dose.  " counter(page);
    font-size: 8.5pt;
    color: #444;
